		...
		public class ToArray
		{
			public static Generic.IEnumerable<object[]> Data
			{
				get
				{
					...
					yield return new object[] { new char[0], ((Generic.IEnumerable<char>)new char[0]).GetEnumerator() };
					yield return new object[] { new char[0], "".GetEnumerator() };
					yield return new object[] { new [] { '1', '3', '3', '7' }, "1337".GetEnumerator() };
